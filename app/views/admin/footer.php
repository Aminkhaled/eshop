...
<script src="<?php echo ASSETS ?>admin/js/common-scripts.js"></script>

<script type="text/javascript" src="<?php echo ASSETS ?>admin/js/gritter/js/jquery.gritter.js"></script>
<script type="text/javascript" src="<?php echo ASSETS ?>admin/js/gritter-conf.js"></script>

<!--script for this page-->
<script src="<?php echo ASSETS ?>admin/js/sparkline-chart.js"></script>
<script src="<?php echo ASSETS ?>admin/js/zabuto_calendar.js"></script>
